...
const pb_field_t ResponseMessage_fields[19] = {
    ...
    PB_FIELD( 16, UINT32  , OPTIONAL, STATIC  , OTHER, ResponseMessage, left_lidar, right_output, 0),
    PB_FIELD( 17, UINT32  , OPTIONAL, STATIC  , OTHER, ResponseMessage, center_lidar, left_lidar, 0),
    PB_FIELD( 18, UINT32  , OPTIONAL, STATIC  , OTHER, ResponseMessage, right_lidar, center_lidar, 0),
    PB_LAST_FIELD
};
